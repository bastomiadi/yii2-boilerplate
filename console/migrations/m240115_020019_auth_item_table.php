   ...
   public function safeUp()
   {
       ...
       $this->batchInsert('{{%auth_item}}',
           ['name', 'type', 'description', 'rule_name', 'data', 'created_at', 'updated_at'], [
               ...
               ['/v1/categories/restore', 2, NULL, NULL, NULL, new Expression('unix_timestamp(NOW())'), new Expression('unix_timestamp(NOW())')],
               ...
               ['/v1/products/restore', 2, NULL, NULL, NULL, new Expression('unix_timestamp(NOW())'), new Expression('unix_timestamp(NOW())')],
               ...
               ['/v1/classes/restore', 2, NULL, NULL, NULL, new Expression('unix_timestamp(NOW())'), new Expression('unix_timestamp(NOW())')],
               ...
               ['/v1/sections/restore', 2, NULL, NULL, NULL, new Expression('unix_timestamp(NOW())'), new Expression('unix_timestamp(NOW())')],
               ...
               ['/v1/students/restore', 2, NULL, NULL, NULL, new Expression('unix_timestamp(NOW())'), new Expression('unix_timestamp(NOW())')],
