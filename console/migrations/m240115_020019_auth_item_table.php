   ...
   public function safeUp()
   {
       ...
       $this->batchInsert('{{%auth_item}}',
           ['name', 'type', 'description', 'rule_name', 'data', 'created_at', 'updated_at'], [
               ...
               ['/audit-entry/*', 2, NULL, NULL, NULL, 0, 0],
               ['/audit-entry/index', 2, NULL, NULL, NULL, 0, 0],
               ['/user/*', 2, NULL, NULL, NULL, 0, 0],
               ['/user/index', 2, NULL, NULL, NULL, 0, 0],

               //for restful permission v1
               ['/v1/categories/index', 2, NULL, NULL, NULL, 0, 0],
               ['/v1/categories/create', 2, NULL, NULL, NULL, 0, 0],
               ['/v1/categories/update', 2, NULL, NULL, NULL, 0, 0],
               ['/v1/categories/delete', 2, NULL, NULL, NULL, 0, 0],
               ['/v1/products/index', 2, NULL, NULL, NULL, 0, 0],
               ['/v1/products/create', 2, NULL, NULL, NULL, 0, 0],
               ['/v1/products/update', 2, NULL, NULL, NULL, 0, 0],
               ['/v1/products/delete', 2, NULL, NULL, NULL, 0, 0],
               ['/v1/classes/index', 2, NULL, NULL, NULL, 0, 0],
               ['/v1/classes/create', 2, NULL, NULL, NULL, 0, 0],
               ['/v1/classes/update', 2, NULL, NULL, NULL, 0, 0],
               ['/v1/classes/delete', 2, NULL, NULL, NULL, 0, 0],
               ['/v1/sections/index', 2, NULL, NULL, NULL, 0, 0],
               ['/v1/sections/create', 2, NULL, NULL, NULL, 0, 0],
               ['/v1/sections/update', 2, NULL, NULL, NULL, 0, 0],
               ['/v1/sections/delete', 2, NULL, NULL, NULL, 0, 0],
               ['/v1/students/index', 2, NULL, NULL, NULL, 0, 0],
               ['/v1/students/create', 2, NULL, NULL, NULL, 0, 0],
               ['/v1/students/update', 2, NULL, NULL, NULL, 0, 0],
               ['/v1/students/delete', 2, NULL, NULL, NULL, 0, 0],
