...
use common\models\v1\search\ProfilesSearch;
use Yii;
...
class ProfilesController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax)
        {
            ...
            */
            ...
            {
                return [
                    'title' => Yii::t('yii2-ajaxcrud', 'Create New')." Profiles",
            ...
            else if($model->load($request->post()))
            {
                ...
                return [
                    ...
                    'title' => Yii::t('yii2-ajaxcrud', 'Create New')." Profiles",
                    'content' => '<span class="text-success">'.Yii::t('yii2-ajaxcrud', 'Create').' Profiles '.Yii::t('yii2-ajaxcrud', 'Success').'</span>',
                    'footer' =>  Html::button(Yii::t('yii2-ajaxcrud', 'Close'), ['class' => 'btn btn-default pull-left', 'data-dismiss' => 'modal']).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax)
        {
            ...
            */
            ...
            {
                return [
                    'title' => Yii::t('yii2-ajaxcrud', 'Update')." Profiles #".$id,
    ...
    /**
     * Delete an existing Profiles model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Profiles model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
