...
/* @var $searchModel common\models\v1\Search\AuditEntrySearch */
        ...
        <?=GridView::widget([
            ...
            'toolbar' => [
                ['content'=>
                    ...
                    ['role' => 'modal-remote', 'title' => Yii::t('yii2-ajaxcrud', 'Create New').' Audit Entries', 'class' => 'btn btn-outline-primary']).
